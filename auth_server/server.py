...
class SimplifiedCognitoValidator:
    ...
    def validate_self_signed_token(self, access_token: str) -> dict:
        ...
        Delegates to the shared verify_self_signed_user_token() function.
        See auth_server/self_signed_token.py for the consolidated implementation.
        """
        from self_signed_token import verify_self_signed_user_token

        return verify_self_signed_user_token(access_token)
