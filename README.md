...
- **💬 Interactive MCP-Gateway CLI** - Terminal-based chat interface with AI-powered MCP tool discovery. Supports Amazon Bedrock and Anthropic API. [MCP-Gateway Guide](docs/mcp-registry-cli.md)
