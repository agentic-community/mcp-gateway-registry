...
class TestIsSafeOverrideKey:
    ...
    def test_accepts_normal_tool_names(self):
        assert ServerService.is_safe_override_key("show_processlist")
        assert ServerService.is_safe_override_key("resolve-library-id")
        assert ServerService.is_safe_override_key("aws___read_documentation")
    ...
    def test_rejects_dotted_names(self):
        ...
        assert not ServerService.is_safe_override_key("foo.bar")

    def test_rejects_dollar_prefix(self):
        assert not ServerService.is_safe_override_key("$set")

    def test_rejects_empty(self):
        assert not ServerService.is_safe_override_key("")
