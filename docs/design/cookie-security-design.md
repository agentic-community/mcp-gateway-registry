...
**Code Logic** ([`auth_server/server.py`](../../auth_server/server.py)):
```python
...
- **Auth Server Cookie Setting:** [`auth_server/server.py`](../../auth_server/server.py)
...
- **Registry Cookie Setting:** [`registry/auth/routes.py`](../../registry/auth/routes.py)
