...
### Documentation
- [A2A Agents README](https://github.com/agentic-community/mcp-gateway-registry/blob/main/agents/a2a/README.md) - A2A agent setup and usage
- [OAuth2 Configuration](https://github.com/agentic-community/mcp-gateway-registry/blob/main/.env.example) - Environment variable reference
